...
public class AppointmentControllerTest extends BaseIntegrationTest {
  ...
  @Test
  void findAllAppointments_Should_return200AndPaginatedAppointments_When_authenticatedAsAdmin() {
    given()
  ...
  @Test
  void findAllAppointments_Should_return401_When_notLogged() {
    given()
        .contentType(ContentType.JSON)
        .accept(ContentType.JSON)
        .when()
  ...
  @Test
  void findAppointmentsByDate_Should_return200AndFilteredAppointments_When_validDateProvidedAndAdminLogged() {
    String targetDate = "2025-12-20";
    ...
    given()
        ...
        .statusCode(HttpStatus.OK.value())
        .body("content", not(empty()))
        .body("content[0].date", startsWith(targetDate));
  }
